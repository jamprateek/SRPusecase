# Map · United States · Midland Basin · All fields

Upload **`map.png`** (or `map.jpg`) here. It's shown on the dashboard when the selectors are set to **United States · Midland Basin · All fields**.
...
31 SRPs are in this area. Your image must cover at least:

| | Latitude / longitude |
|---|---|
| North-west (top-left) | 32.661, -102.947 |
| South-east (bottom-right) | 31.012, -101.61 |

Open this area in Google Maps: https://www.google.com/maps/@31.8365,-102.2785,10z
