# Map · United States · Midland Basin · Andrews field

Upload **`map.png`** (or `map.jpg`) here. It's shown on the dashboard when the selectors are set to **United States · Midland Basin · Andrews field**.
...
| | Latitude / longitude |
|---|---|
| North-west (top-left) | 32.371, -102.808 |
| South-east (bottom-right) | 32.184, -102.445 |

Open this area in Google Maps: https://www.google.com/maps/@32.2775,-102.6265,12z
