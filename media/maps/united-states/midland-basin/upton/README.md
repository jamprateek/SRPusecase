# Map · United States · Midland Basin · Upton field

Upload **`map.png`** (or `map.jpg`) here. It's shown on the dashboard when the selectors are set to **United States · Midland Basin · Upton field**.
...
| | Latitude / longitude |
|---|---|
| North-west (top-left) | 31.536, -102.222 |
| South-east (bottom-right) | 31.2, -101.808 |

Open this area in Google Maps: https://www.google.com/maps/@31.3680,-102.0150,12z
