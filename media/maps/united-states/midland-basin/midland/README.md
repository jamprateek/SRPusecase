# Map · United States · Midland Basin · Midland field

Upload **`map.png`** (or `map.jpg`) here. It's shown on the dashboard when the selectors are set to **United States · Midland Basin · Midland field**.
...
9 SRPs are in this area. Your image must cover at least:

| | Latitude / longitude |
|---|---|
| North-west (top-left) | 32.062, -102.244 |
| South-east (bottom-right) | 31.752, -101.857 |

Open this area in Google Maps: https://www.google.com/maps/@31.9070,-102.0505,12z
