# Map · United States · All regions

Upload **`map.png`** (or `map.jpg`) here. It's shown on the dashboard when the selectors are set to **United States · All regions**.
...
56 SRPs are in this area. Your image must cover at least:

| | Latitude / longitude |
|---|---|
| North-west (top-left) | 32.661, -104.171 |
| South-east (bottom-right) | 31.012, -101.406 |

Open this area in Google Maps: https://www.google.com/maps/@31.8365,-102.7885,9z
