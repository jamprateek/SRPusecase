# Map · United States · Delaware Basin · Reeves field

Upload **`map.png`** (or `map.jpg`) here. It's shown on the dashboard when the selectors are set to **United States · Delaware Basin · Reeves field**.
...
10 SRPs are in this area. Your image must cover at least:

| | Latitude / longitude |
|---|---|
| North-west (top-left) | 31.594, -103.838 |
| South-east (bottom-right) | 31.265, -103.406 |

Open this area in Google Maps: https://www.google.com/maps/@31.4295,-103.6220,12z
