# Map · United States · Delaware Basin · Ward field

Upload **`map.png`** (or `map.jpg`) here. It's shown on the dashboard when the selectors are set to **United States · Delaware Basin · Ward field**.
...
| | Latitude / longitude |
|---|---|
| North-west (top-left) | 31.719, -103.225 |
| South-east (bottom-right) | 31.43, -102.91 |

Open this area in Google Maps: https://www.google.com/maps/@31.5745,-103.0675,12z
