# Map · United States · Delaware Basin · Loving field

Upload **`map.png`** (or `map.jpg`) here. It's shown on the dashboard when the selectors are set to **United States · Delaware Basin · Loving field**.
...
7 SRPs are in this area. Your image must cover at least:

| | Latitude / longitude |
|---|---|
| North-west (top-left) | 32.018, -103.715 |
| South-east (bottom-right) | 31.714, -103.412 |

Open this area in Google Maps: https://www.google.com/maps/@31.8660,-103.5635,12z
