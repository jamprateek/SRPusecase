# Map · Oman · South Oman · All fields

Upload **`map.png`** (or `map.jpg`) here. It's shown on the dashboard when the selectors are set to **Oman · South Oman · All fields**.
...
| | Latitude / longitude |
|---|---|
| North-west (top-left) | 18.766, 54.878 |
| South-east (bottom-right) | 17.866, 55.995 |

Open this area in Google Maps: https://www.google.com/maps/@18.3160,55.4365,10z
