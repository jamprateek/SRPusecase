# Map · Oman · South Oman · Nimr field

Upload **`map.png`** (or `map.jpg`) here. It's shown on the dashboard when the selectors are set to **Oman · South Oman · Nimr field**.
...
3 SRPs are in this area. Your image must cover at least:

| | Latitude / longitude |
|---|---|
| North-west (top-left) | 18.669, 55.649 |
| South-east (bottom-right) | 18.449, 55.867 |

Open this area in Google Maps: https://www.google.com/maps/@18.5590,55.7580,13z
