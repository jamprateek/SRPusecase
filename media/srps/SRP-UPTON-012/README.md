...
**Warning · High rod contamination** · Upton field, Midland Basin, United States

> Grey-level gradient darkening on mid-rod section; blackness ratio above warning threshold.

## What the images should show
Show a **darkened / grey oily film along the rod**, not concentrated at the stuffing box. Movement can look normal.
