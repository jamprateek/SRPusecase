...
**Offline** · Andrews field, Midland Basin, United States

> No burst received for 4 upload cycles.

## What the images should show
This camera is shown as **offline** (no recent upload), so it does not need media. Leave it empty.
