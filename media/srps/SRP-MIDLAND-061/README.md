...
**Warning · Pump-off** · Midland field, Midland Basin, United States

> Incomplete downstroke detected in 2 of the last 3 bursts; cycle shape irregular.

## What the images should show
The rod should be **moving, but irregularly**: short or incomplete strokes, a pause part-way down. A video is the best way to show this.
